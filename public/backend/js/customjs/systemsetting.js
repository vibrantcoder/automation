var Systemsetting = function(){
    ...
    var system = function(){
        ...
        $("body").on("click","#kt_tagify_1_remove",function(){
            tagify.removeAllTags.bind(tagify);
        })
        $('#timepicker_opening_time').timepicker({ format: 'HH:mm A',minuteStep: 30,});
        $('#timepicker_closing_time').timepicker({format: 'HH:mm A',minuteStep: 30,});
